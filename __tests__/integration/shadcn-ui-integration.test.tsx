...
describe('Shadcn UI Integration Tests', () => {
  ...
  describe('Responsive Behavior', () => {
    ...
    it('card layout adapts to content', () => {
      ...
      const header = within(card!).getByText('Shadcn UI Test Components').closest('[data-slot="card-header"]')
      const content = within(card!).getByLabelText('Test Input').closest('[data-slot="card-content"]')
  ...
  describe('Accessibility Integration', () => {
    ...
    it('alert has proper role and content structure', () => {
      ...
      const alertContainer = screen.getByText('Shadcn UI has been successfully configured!').parentElement
